...
if not BASE_URL:
    raise ValueError("缺少必需的环境变量: OPENAI_BASE_URL")
if not MODEL_ID:
    raise ValueError("缺少必需的环境变量: MODEL_NAME")
...
# --- 2. 初始化 ---
user_prompt = "你好，请帮我查询一下今天南京栖霞区的天气，然后根据天气推荐一个合适的旅游景点。"
...
for i in range(5): # 设置最大循环次数
    ...
    if action_str.startswith("Finish"):
        ...
        if final_answer_match:
            ...
            print(f"错误：无法解析 Finish 动作的内容: {action_str}")
        break
